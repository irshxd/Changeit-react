...
<label htmlFor="mytext" className="form-label"><h3>Enter your text here</h3></label>
  ...
  <button className="btn btn-primary my-1 mx-1" onClick={downclick}>Convert to Lowercase</button><br/>
  <button className="btn btn-primary my-1  mx-1" onClick={Copy}>Copy Text</button><br/>
  <button className="btn btn-primary my-1 mx-1" onClick={Cleartext}>Clear Text</button><br/>
  <button className="btn btn-primary my-1 mx-1" onClick={arrangetext}>Arrange Text</button><br/>
</div>
